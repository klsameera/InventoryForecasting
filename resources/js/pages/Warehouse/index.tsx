...
import { create, edit, index } from '@/routes/warehouse';
...
export default function WarehouseIndex({ warehouses, filters }: Props) {
    ...
    const deletingWarehouse = warehouses.data.find(
    ...
    function confirmDelete() {
        ...
        router.delete(WarehouseController.delete.url(deletingId), {
            preserveScroll: true,
            onFinish: () => {
                setProcessing(false);
                setDeletingId(null);
    ...
    return (
        <>
            <PageHeader
                eyebrow="Catalog"
                title="Warehouses"
                description="Locations that hold inventory."
                actions={
            ...
            <ConfirmDialog
                ...
                description={
                    deletingWarehouse
                        ? `This permanently removes "${deletingWarehouse.name}" from the warehouse list.`
                        : undefined
                }
                confirmLabel="Delete"
